...
const ICON_BADGE_SIZE_SM = "h-10 w-10";
const ICON_BADGE_SIZE_LG = "h-14 w-14";
...
const defaultStats: IconStat[] = [
  ...
  {
    icon: <ChartIcon className={ICON_SIZE} />,
    value: "300%",
    label: "ROI Average",
    description: "For our customers",
  },
  {
    icon: <GlobeIcon className={ICON_SIZE} />,
    value: "40+",
    label: "Countries",
    description: "Worldwide reach",
  },
  {
    icon: <ClockIcon className={ICON_SIZE} />,
    value: "<1hr",
    label: "Response Time",
            ...
            if (variant === "minimal") {
              return (
                <div key={stat.label} className="flex items-start gap-4">
                  <div
                    className="mt-1 flex-shrink-0 text-[var(--stats-icon-accent,hsl(220_80%_55%))]"
                    aria-hidden="true"
                  >
                    {stat.icon}
                  </div>
                  <div>
                    <dd className="text-2xl font-bold text-[var(--stats-icon-value-color,hsl(0_0%_9%))]">
                      {stat.value}
                    </dd>
                    <dt className="text-sm font-medium text-[var(--stats-icon-label-color,hsl(0_0%_30%))]">
                      {stat.label}
                    </dt>
                  </div>
                </div>
            ...
            if (variant === "icon-top") {
              return (
                <div key={stat.label} className="text-center">
                  ...
                  <dd className="text-3xl font-bold text-[var(--stats-icon-value-color,hsl(0_0%_9%))]">
                    {stat.value}
                  </dd>
                  <dt className="mt-1 text-sm font-medium text-[var(--stats-icon-label-color,hsl(0_0%_30%))]">
                    {stat.label}
                  </dt>
                  {stat.description && (
