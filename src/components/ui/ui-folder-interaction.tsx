// @source 21st.dev/r/0xUrvish/folder-interaction
"use client"
...
const Page = () => (
  <div
    className="w-full h-full rounded-xl shadow-lg p-3 sm:p-4"
    style={{
      background: "linear-gradient(to bottom, var(--card), color-mix(in oklch, var(--card) 90%, var(--border)))",
    }}
  >
  ...
  return (
    <div className="w-full flex justify-center items-center">
      ...
      >
        ...
        <div
          className={cn(
            "relative w-[87.5%] mx-auto items-center h-full flex justify-center"
          )}
          style={{
            background: "var(--card)",
            boxShadow:
              "0px 0px 15.7px 16px color-mix(in oklch, var(--muted-foreground) 30%, transparent) inset",
            borderRadius: 10,
          }}
        >
          {/* Pages */}
          {([
            ...
            <motion.div
              ...
              className={`absolute top-2 w-32 h-fit rounded-xl motion-reduce:transition-none ${page.className}`}
            >
              <Page />
            </motion.div>
          ))}
        ...
        <motion.div
          ...
          className="absolute -left-[1px] -right-[1px] -bottom-[1px] z-20 h-44 rounded-3xl origin-bottom flex justify-center items-center overflow-visible motion-reduce:transition-none"
        >
          <svg
          ...
          >
            <foreignObject x="-13" y="-13" width="262.4" height="148.4">
              <div
                style={{
                  ...
                  clipPath: "url(#bgblur_folder_clip)",
                  height: "100%",
                  width: "100%",
                }}
              />
            ...
            <path
              ...
              fill="url(#folder_paint0)"
              fillOpacity="0.3"
              stroke="url(#folder_paint1)"
              strokeWidth="0.7"
            />
            <defs>
              <clipPath
                id="bgblur_folder_clip"
              ...
              >
                <stop stopColor="var(--muted-foreground)" stopOpacity="0.3" />
              ...
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="var(--border)" stopOpacity="0.04" />
                <stop offset="1" stopColor="var(--border)" stopOpacity="0.3" />
              </linearGradient>
            </defs>
          </svg>
        </motion.div>
