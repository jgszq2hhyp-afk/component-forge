    ...
    >
      ...
      <div className="max-w-lg">
        ...
        {estimatedTime && (
          <div className="mt-8">
            ...
            <div className="mx-auto max-w-xs">
              ...
              >
                <div
                  className="maintenance-progress h-full rounded-full"
                  style={{
                    width: '65%',
        ...
        {onEmailSubmit && (
          <div className="mt-10">
            {submitted ? (
              <div
                className="mx-auto max-w-sm rounded-lg px-5 py-4"
                style={{
              ...
              <>
                ...
                <form
                  ...
                  className={cn(
                    'mx-auto flex max-w-sm overflow-hidden rounded-lg',
      ...
      <style
        dangerouslySetInnerHTML={{
          __html: `
            .maintenance-icon {
              animation: maintenanceSpin 8s linear infinite;
            }
            .maintenance-progress {
              animation: maintenanceGrow 1.2s ease-out both;
            }
