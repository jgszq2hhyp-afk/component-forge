// @source 21st.dev/r/easemize/cinematic-landing-hero
"use client";
...
const INJECTED_STYLES = `
  ...
  @media (prefers-reduced-motion: reduce) {
    .gsap-reveal, .film-grain, .bg-grid-theme,
    .btn-modern-light, .btn-modern-dark,
    .floating-ui-badge, .iphone-bezel,
    .progress-ring, .animate-pulse {
...
export default function CinematicLandingHero({
  ...
  cardDescription = (
    <>
      <span className="text-white font-semibold">Sobers</span> empowers
      sponsors and sponsees in 12-step recovery programs with structured
      accountability, precise sobriety tracking, and beautiful visual timelines.
    </>
  ),
  metricValue = 365,
      ...
      <div className="cta-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 gsap-reveal pointer-events-auto will-change-transform">
        ...
        <div className="flex flex-col sm:flex-row gap-6">
          <a
            ...
            className="btn-modern-light motion-reduce:transition-none flex items-center justify-center gap-3 px-8 py-4 rounded-[1.25rem] group focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
          >
            <svg
              className="w-8 h-8 transition-transform motion-reduce:transition-none group-hover:scale-105"
              fill="currentColor"
              viewBox="0 0 384 512"
              aria-hidden="true"
            >
          ...
          <a
            ...
            className="btn-modern-dark motion-reduce:transition-none flex items-center justify-center gap-3 px-8 py-4 rounded-[1.25rem] group focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-background"
          >
            <svg
              className="w-7 h-7 transition-transform motion-reduce:transition-none group-hover:scale-105"
              fill="currentColor"
              viewBox="0 0 512 512"
              aria-hidden="true"
            >
                ...
                >
                  ...
                  <div className="absolute inset-[7px] bg-[#050914] rounded-[2.5rem] overflow-hidden shadow-[inset_0_0_15px_rgba(0,0,0,1)] text-white z-10">
                    ...
                    <div className="absolute top-[5px] left-1/2 -translate-x-1/2 w-[100px] h-[28px] bg-black rounded-full z-50 flex items-center justify-end px-3 shadow-[inset_0_-1px_2px_rgba(255,255,255,0.1)]">
                      <div className="w-1.5 h-1.5 rounded-full bg-green-500 shadow-[0_0_8px_rgba(34,197,94,0.8)] animate-pulse motion-reduce:animate-none" />
                    </div>
