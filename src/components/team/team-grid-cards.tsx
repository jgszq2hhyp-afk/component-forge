      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        {(heading || subheading) && (
          <div className="mb-12 text-center">
            {heading && (
              <h2 className="text-2xl sm:text-3xl font-bold text-[var(--team-heading-color,hsl(0_0%_9%))]">
                {heading}
              </h2>
            )}
            {subheading && (
                    ...
                    <div className="mt-4 flex justify-center gap-3">
                      {member.socials.map((s) => (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-[var(--team-social-color,hsl(0_0%_50%))] hover:text-[var(--team-social-hover,hsl(0_0%_20%))] transition-colors motion-reduce:transition-none"
                          aria-label={`${member.name} on ${s.platform}`}
                        >
                          <SocialIcon platform={s.platform} className="h-4 w-4" />
                        </a>
