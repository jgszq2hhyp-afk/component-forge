...
const ICON_BOX_SIZE = "w-10 h-10";
const ICON_BOX_RADIUS = "rounded-lg";
const IMAGE_HEIGHT_SM = "h-40";
const IMAGE_HEIGHT_LG = "lg:h-48";
const FOCUS_RING =
              ...
              {item.imageSrc && (
                ...
                >
                  <Image
                    ...
                    className="bento-card-image object-cover"
                  />
                </figure>
              )}
